...
function ThemeMenu() {
  ...
  return (
    <Menu as="div" className="relative flex items-center text-left">
      <Menu.Button className="flex flex-col items-center self-end justify-center flex-auto w-8 h-8 r unded-full bg-transparent border-transparent hover:bg-400 active:bg-400 active:text-500 text-600 focus:outline-none hover:text-700 dark:hover:bg-slate-500">
        <svg
