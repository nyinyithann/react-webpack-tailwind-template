...
function About() {
  return (
    <div className="flex flex-col gap-2 text-primary_600 font-primary text-center h-full items-center justify-center">
      <div className="-mt-40">
        ...
        <div className="pt-2 font-secondary text-base">
          <div className="flex flex-col justify-center items-center font-normal  mt-4 pt-2 border-t border-primary_200 dark:border-slate-400">
            <div className="w-24 h-24 relative">
              ...
              />
              <span className="bg-primary_900 rounded-full text-xs text-primary_200 p-1 absolute right-1 -top-1 border-2 border-primary_300 dark:bg-slate-500 dark:text-white">
                By{' '}
              </span>
            </div>
            <AuthorLink
